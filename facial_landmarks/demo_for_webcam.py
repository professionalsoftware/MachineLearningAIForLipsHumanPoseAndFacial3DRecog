...
def main():
    ...
    while is_frame_grabbed is False:
        is_frame_grabbed, sample_frame = cap.read()

    # check if ratation to vertical
    if args.rotation_to_vertical:
        # sample_frame = np.rot90(sample_frame, k=-1, axes=(0, 1))
        sample_frame = imutils.rotate_bound(sample_frame, 90)
